...
public class BatteryStatusActivity extends Activity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        registerReceiver(receiver, new IntentFilter(BatteryStatusService.GET_PHONE_STATUS));
    ...
    public void onTimerFinished(View view) {
        ...
        serviceIntent.setAction(BatteryStatusService.GET_PHONE_STATUS);
